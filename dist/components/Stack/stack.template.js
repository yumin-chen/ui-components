...
export var stack = {
    ...
    fields: [
        ...
        },
        {
            ...
            label: "Direction",
            name: "direction",
            description: "An alias for the css `flex-direction` property. Default is `column`.",
            options: [
                {
                    value: "row",
                    label: "Row",
    ...
    ui: {
        defaultItem: function () { return ({
            children: [
                __assign({ _template: "heading" }, headingDefaultItem),
                __assign({ _template: "paragraph" }, paragraphDefaultItem),
                __assign({ _template: "button" }, buttonDefaultItem),
            ],
            direction: "column",
            gap: 1,
            align: "center",
