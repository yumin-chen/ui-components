import React, { type ElementType, type ForwardRefExoticComponent, type PropsWithoutRef, type RefAttributes } from "react";
...
export declare const createStyleContext: <R extends Recipe>(recipe: R) => {
    withRootProvider: <P extends {}>(Component: ElementType) => (props: P) => React.JSX.Element;
